...
public class CheckStockPanel extends javax.swing.JPanel {
    ...
    public CheckStockPanel() {
        ...
        tblCheckStock.getTableHeader().setFont(new Font("Kanit", Font.PLAIN, 14));
        tblCheckStock.setModel(new AbstractTableModel() {
            ...
            public Object getValueAt(int rowIndex, int columnIndex) {
                CheckStock checkStock = list.get(rowIndex);
                switch (columnIndex) {
                    case 0:
                        ImageIcon icon = new ImageIcon("./checkStock"+checkStock.getId()+".png");
                    ...
                    case 2:
                        return checkStock.getLogin();
                    case 3:
                        return checkStock.getCheckStockname();
                    case 4:
                        return checkStock.getPassword();
                    case 5:
                        return checkStock.getRole();
                    default:
                        return "Unknown";
                }
            }
    ...
    private void openDialog() {
        ...
        checkStockDialog.setLocationRelativeTo(this); //set dialog to center
    ...
    private void btnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditActionPerformed
        int selectIndex = tblCheckStock.getSelectedRow();
        if (selectIndex >= 0) {
            editedCheckStock = list.get(selectIndex);
            openDialog();
        }
    ...
    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteActionPerformed
        ...
        if (selectIndex >= 0) {
            ...
            if (input == 0) {
                checkStockService.delete(editedCheckStock);
            }
            refreshTable();
        }
